...
async function initDatabase() {
  try {
    ...
    // database/student_life_management.sql ফাইলটির সঠিক পাথ
    const sqlFilePath = path.join(
      __dirname,
      "../database/student_life_management.sql",
    );
    ...
    if (fs.existsSync(sqlFilePath)) {
      ...
      // ২. সেমিকোলন দিয়ে কুয়েরিগুলো আলাদা করা হচ্ছে
      ...
      for (let query of queries) {
        ...
        // কারণ এভিয়েন ডাটাবেজে আমরা সরাসরি defaultdb-র ভেতরে টেবিলগুলো তৈরি করব
        if (
        ...
        try {
          ...
          // যদি টেবিল অলরেডি তৈরি করা থাকে বা ডেমো ডাটা অলরেডি ইনসার্ট করা থাকে, তবে সেই ওয়ার্নিং ইগনোর করব
          if (
